...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~VY4RgDRS#iBr-1YRBE8Z3FudIZQs50g29E5wsBmgqze3tFrOQgFI",
// add your Session Id 
...
MENU_IMAGE_URL: process.env.MENU_IMAGE_URL || "https://files.catbox.moe/j97qag.mp4",
// add custom menu and mention reply image url
PREFIX: process.env.PREFIX || "🩸",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "NLE🩸💤🧃",
// add bot name here for menu
STICKER_NAME: process.env.STICKER_NAME || "NLE🩸💤🧃",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "8493915274",
// add your bot owner number
OWNER_NAME: process.env.OWNER_NAME || "NLE🩸💤🧃",
// add bot owner name
...
DEV: process.env.DEV || "8493915274",
